(function(jsGrid) {
    ...
    jsGrid.locales.ru = {
        ...
        validators: {
            ...
            minLength: { message: "Введенное значение слишком длинное" },
            maxLength: { message: "Введенное значение слишком короткое" },
            ...
            min: { message: "Введенное значение слишком большое" },
            max: { message: "Введенное значение слишком маленькое" }
        }
    };
