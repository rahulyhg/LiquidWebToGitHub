<?php
	...
	define('C_QB_DATABASE','bk6wv3uj4');  // Database ID of the QuickBase being accessed
	define('C_QB_APPTOKEN','wkqdymdv3qpk2dk52pyidk85tvd');  // Application token
	define('C_SALT', 'ABCDEFG'); 

	// QB portal login data
	...
	//QB app data
	define('C_DBID_SPECIALIZATIONS','bk6zg8d45'); // Specializations table id 
	define('C_DBID_CUSTOMER_RFPS','bk6wv3ukn'); // Specializations table id 
	define('C_DBID_QUESTIONS','bk6wv3wa8'); // Questions table id 
	define('C_DBID_OPTINS','bk6wv3wbh'); // Questions table id
	define('C_DBID_SITE_RFPS','bk6wv3way'); // Site rfps table id
	define('C_DBID_CHANNEL_PARTNERS','bk6wv3waw'); // CHANNEL PARTNERS table id
	define('C_DBID_BID_BID_SCENARIOS','bmb6umc7t');
	define('C_DBID_BIDS','bk6wv3vtu');
	define('C_DBID_SITES','bk6wv3vtz');
	define('C_DBID_CUSTOMER_FILES','bmcyw2qk7');
	define('C_DBID_BID_SCENARIOS','bk6wv3wa3');
	define('C_DBID_CHANNEL_PARTNERS_RFP_EMAIL_PREFERENCES','bmb7c7n5f');
	define('C_DBID_FIXTURE_TYPES','bmkuurxka');
	define('C_DBID_TRACKING','bmpufc8qd');
	define('C_DBID_CUSTOMERS','bk6wv3vtt');
