...
<?php 
    ...
    require_once('res/func.php');
    $out ='';
    if (isset($_SESSION['uid'])){$_SESSION['uid'] = $_SESSION['uid'];} else { die('no user id'); $_SESSION['uid'] = '23';}
    if (isset($_SESSION['channel_partner'])){$_SESSION['channel_partner'] = $_SESSION['channel_partner'];} else { die('no channel partner id'); $_SESSION['channel_partner'] = '102';}
?>
        <!-- Page Content -->
    <div id="page-wrapper">
        <div class="container-fluid">
            <div class="row bg-title">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <h4 class="page-title">Awarded RFP Details</h4> 
                </div>
            ...
            <?php echo showSingleRFP($_REQUEST['rfp_rid'],$_REQUEST['channel_partner_id'],'awarded'); ?> 
    ...
    <script>
        jQuery(document).ready(function($) {
            ...
            $.get("https://ipinfo.io/json", function (response) {
                ...
                var page = 'Awarded RFP Detail';
                var file_url = 'awarded_rfp_detail';
                ...
                $.ajax({
                    ...
                    dataType: "json",
                    url: "res/actions.php",
                    data: {action: "page_view", loc: response.loc, page: 'Awarded RFP Detail', file_url: 'awarded_rfp_detail', rfp_rid: rfp_rid},
