    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top m-b-0">
            <div class="navbar-header"> <a class="navbar-toggle hidden-sm hidden-md hidden-lg " href="javascript:void(0)" data-toggle="collapse" data-target=".navbar-collapse"><i class="ti-menu"></i></a>
                <div class="top-left-part" style='background:#464A63'> <a style='min-width:60px;min-height:60px;' class="logo" href="index.php"><!--This is logo--><span class="hidden-xs"><img src="img/logo.png" style='width:154px;margin-left:20px;margin-top:2px;' alt="home" class="dark-logo" /></span></a></div>
                ...
                <!-- <ul class="nav navbar-top-links navbar-left pull-left">
                    <li style='color:white;padding:20px;'><span>Black Bear's RFP Platform will be down for scheduled maintenance from 3pm MST Saturday to 12pm MST Sunday</span></li>
                </ul> -->
                <ul class="nav navbar-top-links navbar-right pull-right">
                    <li><a href="login.php?logout=true" class="waves-effect"><i class="icon-logout fa-fw"></i> <span class="hide-menu">Log out</span></a></li>
