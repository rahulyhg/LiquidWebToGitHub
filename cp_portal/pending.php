...
<body>
	...
	<section id='wrapper' class='login-register'>
	  	<div class='login-box'>
	    	<a class='text-center db' href='index.php'><img style='width:360px;max-width:100%;' src='img/logo.png' alt='Home' /><br/></a>
	    	<div class='white-box'>
	    		<div>
	    			<div class='well'>Thank you for registering. This account is pending approval. We will send you an email when it's all set.</div>
	    		</div>
