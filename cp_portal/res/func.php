...
//max_input_time (on Apache) need to change
...
function showCustomerRFPs($channel_partner_id) {
	...
	if ($shortlisted[0]){
		...
		for ($a = 0; $a < count($shortlisted); $a++) {
			...
			$out .= "<td class='clickable-row' data-href='rfp_detail.php?rfp_rid=".$rfp_rid."&channel_partner_id=".$channel_partner_id."'>".$rfp_energy_technology."</td>";
			$out .= "<td class='clickable-row' data-href='rfp_detail.php?rfp_rid=".$rfp_rid."&channel_partner_id=".$channel_partner_id."'>".$rfp_status."</td>";
			$out .= "<td class='clickable-row' data-href='rfp_detail.php?rfp_rid=".$rfp_rid."&channel_partner_id=".$channel_partner_id."'>".$rfp_release_date."</td>";
			$out .= "<td class='clickable-row' data-href='rfp_detail.php?rfp_rid=".$rfp_rid."&channel_partner_id=".$channel_partner_id."'>".$rfp_due_date."</td>";
			$out .= "<td class='clickable-row' data-href='rfp_detail.php?rfp_rid=".$rfp_rid."&channel_partner_id=".$channel_partner_id."'>".$rfp_location."</td>";
			$out .= "<td class='clickable-row' data-href='rfp_detail.php?rfp_rid=".$rfp_rid."&channel_partner_id=".$channel_partner_id."'>".$rfp_opportunity."</td>";
			$out .= "<td>".$form1."</td>";
			$out .= "<td>".$form2."</td>";
...
function uploadFileOptin($rfp_rid, $optin_rid, $channel_partner_id, $optin_rfp_response_file, $optin_laf_file, $optin_ppa_file, $optin_bid_form_file,$optin_other_document_file,$channel_partner_qualification_form_file,$category) {
 ...
 //    } catch (RuntimeException $e) {
	...
	//$filename1 = $_FILES['optin_rfp_response_file']['name'];
