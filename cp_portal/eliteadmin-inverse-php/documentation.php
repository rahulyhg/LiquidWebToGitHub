...
&lt;!-- /.right-sidebar --&gt;</pre>
                        ...
                        <p>Below code is used for footer in all pages and you can find this code in <code>footer.php</code> file.</p> <pre class="prettyprint">&lt;footer class="footer text-center"&gt; 2016 &copy; Elite Admin brought to you by themedesigner.in &lt;/footer&gt;
                        </pre>
                        <hr>
...
responsive.less( this less include for responsive layout of the template)
                        ...
                        <p>we make classes to help you in your developement process, and make it fast. checkout the below link for the helper classes</p> <a href="http://eliteadmin.themedesigner.in/demos/eliteadmin-inverse/utility-classes.html" target="_blank" class="btn btn-success btn-rounded">click for the Utility Classes</a>
                        <hr>
                        <div class="clear"></div>
                    </div>
                </div>
               ...
               &lt;body&gt;
                  ...
                  &lt;div class="navbar-default sidebar slimscroll"&gt; &lt;/div&gt;
                   ...
                   <span style="color:#ccc;">&lt;!-- Main Content --&gt;</span>
                    ...
                    &lt;footer class="footer text-center"&gt; 2016 © Eliteadmin brought to you by themedesigner.in &lt;/footer&gt;
