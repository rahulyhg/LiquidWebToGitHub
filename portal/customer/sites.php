...
<head>
  ...
  <style>
   ...
   /* tr {line-height:1.4;background:#f3f3f3;}
    ...
    #total_number_sites {font-size:86%;}*/
  ...
  <div class="container">
    ...
    <div class="row" style="margin-bottom:2rem;margin-top:3rem;">
      <div class="twelve columns">
        <span class="label-primary u-full-width" id='sites_all'>All Sites</span>
 ...
 $('#my_sites').addClass('active');
    ...
    $( document ).ready(function() {
      ...
      $( '#load_all_listings' ).click( function(){
        getNextPage('get_sites','all', page_all, true);
        $('#5of_all').html('');
      });

      $( '#load_all_listings_solar' ).click( function(){
        getNextPage('get_sites_solar', 'solar', page_solar, true);
        $('#5of_solar').html('');
      });

      $( '#load_all_listings_storage' ).click( function(){
        getNextPage('get_sites_storage', 'storage', page_storage, true);
        $('#5of_storage').html('');
      });

      $( '#load_all_listings_led' ).click( function(){
        getNextPage('get_sites_led', 'led', page_led, true);
        $('#5of_led').html('');  
      });
